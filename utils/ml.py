...
def build_mlp_model(meta, 
    ...
    compile_kwargs = compile_kwargs or dict()
   
    if not compile_kwargs.get('optimizer', None):
      compile_kwargs['optimizer'] = opt
    if not compile_kwargs.get('loss', None):
      compile_kwargs['loss'] = loss_fn
